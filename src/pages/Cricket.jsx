                    ...
                    <div className="md:col-span-5 p-4 rounded-lg">
                        <div className="p-6 rounded-2xl shadow-lg bg-white dark:bg-background space-y-4">
                            ...
                            <div className="grid grid-cols-1 gap-4">
                                <div className="p-3 rounded-lg shadow-sm bg-green-10 dark:bg-green-950">
                        ...
                        {/*Prediction Tips*/}
                        <div className="mt-10 p-6 rounded-2xl shadow-lg bg-white dark:bg-background space-y-4">
                            <h2 className="text-xl font-semibold flex items-center gap-2">
                                <Lightbulb className="w-5 h-5 text-green-500 " strokeWidth={3}/> Prediction Tips
                            </h2>

                            <div className="space-y-4">
                                <div className="flex items-start gap-3 p-3 rounded-lg shadow-sm bg-green-50 dark:bg-green-950">
                                    <TrendingUp className="w-5 h-5 text-green-500 strokeWidth={2.5}" />
                                    <div>
                                ...
                                <div className="flex items-start gap-3 p-3 rounded-lg shadow-sm bg-green-50 dark:bg-green-950">
                                    <CloudSun className="w-5 h-5 text-green-500 strokeWidth={2.5}" />
                                    <div>
                                ...
                                <div className="flex items-start gap-3 p-3 rounded-lg shadow-sm bg-green-50 dark:bg-green-950 ">
                                    <Users className="w-5 h-5 text-green-500 strokeWidth={2.5}" />
                                    <div>
                                ...
                                <div className="flex items-start gap-3 p-3 rounded-lg shadow-sm bg-green-50 dark:bg-green-950">
                                    <Radio className="w-5 h-5 text-green-500 strokeWidth={2.5}" />
                                    <div>
